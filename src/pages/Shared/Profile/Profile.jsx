        ...
        <div class="mb-8">
            <div class="p-8 bg-white shadow mt-24">
                ...
                <div class="mt-20 text-center border-b pb-12">
                    <h1 class="text-4xl font-medium text-gray-700">{user?.displayName} 
                    </h1>
                    <p class="badge badge-lg bg-green-300">{role}</p>
                    <p class="font-bold text-gray-600 mt-3">{user?.email}</p>
